        ...
        <div className="flex flex-col items-center justify-center gap-12 w-full">
          ...
          <div className="animate-fade-in space-y-8 w-full flex flex-col items-center justify-center">
            <div className="w-full flex flex-col items-center justify-center">
              <h1 className="text-4xl md:text-6xl font-bold text-primary mb-6 leading-tight text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-fit sm:w-full items-center justify-center">
              <a
                href="#contact"
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-accent transition-colors duration-300 group w-full sm:w-auto"
              >
                Reserva tu turno
                <ArrowRight
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-primary text-primary rounded-lg font-semibold hover:bg-primary/5 transition-colors duration-300 w-full sm:w-auto"
              >
                WhatsApp
              </a>
            </div>
